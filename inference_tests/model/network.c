...
#define AI_NETWORK_MODEL_SIGNATURE     "e25dda34a625e5692209df589b79c399"
...
#define AI_TOOLS_DATE_TIME   "Sat Feb  3 11:34:51 2024"
...
AI_ARRAY_OBJ_DECLARE(
  ...
  NULL, NULL, 286, AI_STATIC)
/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_output0_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 9152, AI_STATIC)
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_scratch0_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#4 */
AI_ARRAY_OBJ_DECLARE(
  _dense_Gemm_output_0_output_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_kernel_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 128, AI_STATIC)
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_recurrent_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 4096, AI_STATIC)
/* Array#8 */
AI_ARRAY_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_peephole_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 96, AI_STATIC)
/* Array#9 */
AI_ARRAY_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 128, AI_STATIC)
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
...
/* Array#11 */
AI_ARRAY_OBJ_DECLARE(
  _dense_Gemm_output_0_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 64, AI_STATIC)
/* Array#12 */
AI_ARRAY_OBJ_DECLARE(
  _dense_Gemm_output_0_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 2, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 286), AI_STRIDE_INIT(4, 4, 4, 4, 4),
  1, &input_output_array, NULL)

/* Tensor #1 */
AI_TENSOR_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_output0, AI_STATIC,
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 286), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &_lstm_LSTM_output_0_forward_output0_array, NULL)

/* Tensor #2 */
AI_TENSOR_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_scratch0, AI_STATIC,
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 224, 1, 1), AI_STRIDE_INIT(4, 4, 4, 896, 896),
  1, &_lstm_LSTM_output_0_forward_scratch0_array, NULL)
...
/* Tensor #4 */
AI_TENSOR_OBJ_DECLARE(
  _dense_Gemm_output_0_output, AI_STATIC,
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 1, 1), AI_STRIDE_INIT(4, 4, 4, 8, 8),
  1, &_dense_Gemm_output_0_output_array, NULL)
...
/* Tensor #6 */
AI_TENSOR_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_kernel, AI_STATIC,
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 1, 1), AI_STRIDE_INIT(4, 4, 4, 512, 512),
  1, &_lstm_LSTM_output_0_forward_kernel_array, NULL)

/* Tensor #7 */
AI_TENSOR_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_recurrent, AI_STATIC,
  7, 0x0,
  AI_SHAPE_INIT(4, 32, 128, 1, 1), AI_STRIDE_INIT(4, 4, 128, 16384, 16384),
  1, &_lstm_LSTM_output_0_forward_recurrent_array, NULL)

/* Tensor #8 */
AI_TENSOR_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_peephole, AI_STATIC,
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 96), AI_STRIDE_INIT(4, 4, 4, 384, 384),
  1, &_lstm_LSTM_output_0_forward_peephole_array, NULL)

/* Tensor #9 */
AI_TENSOR_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_bias, AI_STATIC,
  9, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 1, 1), AI_STRIDE_INIT(4, 4, 4, 512, 512),
  1, &_lstm_LSTM_output_0_forward_bias_array, NULL)
...
/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  _dense_Gemm_output_0_weights, AI_STATIC,
  11, 0x0,
  AI_SHAPE_INIT(4, 32, 2, 1, 1), AI_STRIDE_INIT(4, 4, 128, 256, 256),
  1, &_dense_Gemm_output_0_weights_array, NULL)

/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  _dense_Gemm_output_0_bias, AI_STATIC,
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 1, 1), AI_STRIDE_INIT(4, 4, 4, 8, 8),
  1, &_dense_Gemm_output_0_bias_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_dense_Gemm_output_0_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  _dense_Gemm_output_0_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_Gather_output_0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_dense_Gemm_output_0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &_dense_Gemm_output_0_weights, &_dense_Gemm_output_0_bias),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  _dense_Gemm_output_0_layer, 4,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &_dense_Gemm_output_0_chain,
  NULL, &output_layer, AI_STATIC, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  _Gather_output_0_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &_lstm_LSTM_output_0_forward_output0, &_Constant_1_output_0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_Gather_output_0_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  _Gather_output_0_layer, 3,
  GATHER_TYPE, 0x0, NULL,
  gather, forward_gather,
  &_Gather_output_0_chain,
  NULL, &_dense_Gemm_output_0_layer, AI_STATIC, 
  .axis = AI_SHAPE_HEIGHT, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_lstm_LSTM_output_0_forward_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 9, &_lstm_LSTM_output_0_forward_kernel, &_lstm_LSTM_output_0_forward_recurrent, &_lstm_LSTM_output_0_forward_peephole, &_lstm_LSTM_output_0_forward_bias, NULL, NULL, NULL, NULL, NULL),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_lstm_LSTM_output_0_forward_scratch0)
)

AI_LAYER_OBJ_DECLARE(
  _lstm_LSTM_output_0_forward_layer, 1,
  LSTM_TYPE, 0x0, NULL,
  lstm, forward_lstm,
  &_lstm_LSTM_output_0_forward_chain,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 18060, 1, 1),
    18060, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 37504, 1, 1),
    37504, NULL, NULL),
  ...
  &_lstm_LSTM_output_0_forward_layer, 0, NULL)
