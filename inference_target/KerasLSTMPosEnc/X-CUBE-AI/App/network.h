...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "batch1_vanilla_lstm_posenc_coffee"
...
#define AI_NETWORK_IN_1_HEIGHT      (286)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (286 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (1144)
